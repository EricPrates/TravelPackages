...
class TravelPackage extends Model {
    static init(sequelize, DataTypes) {
        return super.init({
            ...
            totalPriceMiles: {type: DataTypes.DECIMAL(10, 2),allowNull: false, defaultValue: 0},
     ...
     calculatePrices() {
        ...
        this.totalPriceMiles = components.reduce((total, component) => {
            return total + (component.priceMiles || 0);
        }, 0);
