        ...
        <ScrollView style={styles.container}>
            ...
            <View style={styles.section}>
                ...
                <View style={styles.infoRow}>
                    ...
                    <Text style={styles.infoValue}>{formatCurrency(purchase.paidInMoney)}</Text>
                </View>
                <View style={styles.infoRow}>
                    <Text style={styles.infoLabel}>Pago em milhas:</Text>
                    <Text style={styles.infoValue}>{formatMiles(purchase.paidInMiles)}</Text>
                </View>
            </View>
            ...
            <View style={styles.summaryCard}>
                ...
                <View style={styles.summaryRow}>
                    ...
                    <Text style={styles.summaryAmount}>
                        {formatCurrency(purchase.paidInMoney)} + {formatMiles(purchase.paidInMiles)}
                    </Text>
                </View>
            </View>
        </ScrollView>
...
const styles = StyleSheet.create({
    ...
    summaryCard: { backgroundColor: '#e8f4fd', padding: 16, margin: 16, borderRadius: 8, borderLeftWidth: 4, borderLeftColor: '#1890ff' },
    summaryTitle: { fontSize: 16, fontWeight: 'bold', marginBottom: 8, color: '#1890ff' },
    summaryRow: { flexDirection: 'row', justifyContent: 'space-between' },
    summaryAmount: { fontSize: 16, fontWeight: 'bold', color: '#1890ff' },
